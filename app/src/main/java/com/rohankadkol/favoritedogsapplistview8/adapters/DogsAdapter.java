...
public class DogsListAdapter extends ArrayAdapter<Dog> {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        ImageView ivDog = view.findViewById(R.id.iv_dog);
        TextView tvName = view.findViewById(R.id.tv_name);
        TextView tvBreed = view.findViewById(R.id.tv_breed);

        Picasso.get().load(mDogs[position].getImageUrl()).into(ivDog);
        Log.d(TAG, "getView: imageUrl = " + mDogs[position].getImageUrl());
